import { Box, debounce, ListItemButton, TextField } from "@mui/material";
import { FieldValues, useController, UseControllerProps } from "react-hook-form";
import { LocationIQSuggestion } from "../../models/Location";
            ...
            <List>
                {suggestions.map(suggestion => (
                    ...
                    >
                        ...
                        <List.Content>
                            <List.Header>{suggestion.display_name}</List.Header>
                        </List.Content>
                    </ListItemButton>
            ))}
            </List>)}
